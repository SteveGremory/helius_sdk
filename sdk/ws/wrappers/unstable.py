...
class UnstableSubscriptionWS(BaseHeliusWS):
    """
    Handles unstable subscription types that may not be fully supported by Helius.
    """
    ...
    async def slots_updates_subscribe(self):
        ...
        """
        print(
            "WARNING: slotsUpdatesSubscribe is marked as unstable and is not supported by Helius."
        )
    ...
    async def vote_subscribe(self):
        ...
        """
        print(
            "WARNING: voteSubscribe is marked as unstable and is not supported by Helius."
        )
